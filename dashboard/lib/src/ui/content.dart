...
String buildPageContent({
  ...
  switch (page) {
    ...
    case DashboardPage.workers:
      return _workersContent(workers);
  }
}
...
String _workersContent(List<WorkerStatus> workers) {
...
<section class="page-header">
  <h1>Workers</h1>
  <p class="page-subtitle">
    Heartbeat health, queue assignments, and in-flight counts. Control commands (ping, pause, revoke) arrive in subsequent revisions.
  </p>
</section>
...
<section class="table-card">
  <table>
    ...
    <tbody>
      ${workers.isEmpty ? '''
              <tr>
                <td colspan="4" class="muted">No heartbeats detected for namespace "${workers.isEmpty ? 'stem' : workers.first.namespace}".</td>
              </tr>
