...
class AddWorkflowRunLeases extends Migration {
  ...
  void up(SchemaBuilder schema) {
    schema.table('stem_workflow_runs', (table) {
      ...
      table.index(['owner_id'], name: 'stem_workflow_runs_owner_idx');
      table.index([
        'lease_expires_at',
      ], name: 'stem_workflow_runs_lease_idx');
    });
  }
  ...
  void down(SchemaBuilder schema) {
    schema.table('stem_workflow_runs', (table) {
      table
        ..dropIndex('stem_workflow_runs_owner_idx')
        ..dropIndex('stem_workflow_runs_lease_idx')
        ..dropColumn('owner_id')
